...
const backgrounds = [
  {
    ...
    description: 'Curabitur lobortis id lorem id bibendum. Ut id consectetur magna. Quisque volutpat auque enim, pulvinar lobortis.',
    ...
    return (
      <Block safe>
        ...
        >
          ...
          >
            Curabitur lobortis id lorem id bibendum. Ut id consectetur magna. Quisque volutpat auque enim, pulvinar lobortis.
          </Text>
          {this.renderDots()}
          <Button
            primary
